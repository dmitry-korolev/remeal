...
![Dark theme](/examples/dark.png?raw=true "Dark theme")
![Light theme](/examples/light.png?raw=true "Light theme")
![Settings](/examples/control.png?raw=true "Settings panel")
